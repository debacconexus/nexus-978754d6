...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Commercial Lending Portfolio Management Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Loan Portfolio Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "loan_portfolio_record_records";
'use strict';
